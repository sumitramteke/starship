...
1. Add the init script to your shell's config file:
   ...
   Add the following to the end of `~\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1` (or `~/.config/powershell/Microsoft.PowerShell_profile.ps1` on -Nix):
